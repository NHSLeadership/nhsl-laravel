<nav class="nhsuk-header__navigation" id="header-navigation" role="navigation" aria-label="Primary navigation"
    ...
    <div class="nhsuk-width-container">
        ...
        @if(Route::has('home') && Route::is('home'))
            <li class="nhsuk-header__navigation-item nhsuk-header__navigation-item__item--current"
                aria-current="page">
        @else
            ...
            @else
                ...
                <li class="nhsuk-header__navigation-item">
                    <a class="nhsuk-header__navigation-link" href="{{ Route::has('login') ? route('login') : '' }}">
            ...
            @if(Route::has('contact-us') && Route::is('contact-us'))
                <li class="nhsuk-header__navigation-item nhsuk-header__navigation-item__item--current"
                    aria-current="page">
            @else
                <li class="nhsuk-header__navigation-item">
                    @endif
                    <a class="nhsuk-header__navigation-link"
                       href="{{ Route::has('contact-us') ? route('contact-us') : '' }}">
                        Contact Us
                        <svg class="nhsuk-icon nhsuk-icon__chevron-right" xmlns="http://www.w3.org/2000/svg"
                             viewBox="0 0 24 24" aria-hidden="true">
                            <path
